...
class CloudTranslationClientTest(parameterized.TestCase):
  ...
  # TODO(): Fix issue where keyword insertion tag in ad text contains
  # numeric key. E.g, {0:buy now} should read {Keyword:buy now}.
  # @parameterized.named_parameters(
  #     {
  #         'testcase_name': 'without_glossary',
  #         'mock_glossary_id': '',
  ...
  def test_translate_shortens_translations(self):
    ...
    mock_vertex_client.shorten_text_to_char_limit.side_effect = [
        ...
        # contains numeric key before uncommenting.
        # ['shortened2'],
    ]
    ...
    expected_translated_df = pd.DataFrame({
        'source_term': [
            ...
            'term_that_fits_2',
            'term_to_overflow_{keyword:3}',
            # TODO(): Fix issue where keyword insertion tag in ad
            # text contains numeric key before uncommenting.
            # 'term_to_overflow_{0:3}',
        ],
        'target_terms': [
    ...
    self.mock_send_api_request.side_effect = [
        {'translations': [
            ...
            {'translatedText': 'untruncated_translation_{keyword:3}'}]},]
            # TODO(): Fix issue where keyword insertion tag in ad
            # text contains numeric key before uncommenting.
    ...
    # Asserts the number of characters sent to the Cloud Translation API.
    self.assertEqual(
        self.cloud_translation_client.get_translated_characters(), 96
        # TODO(): Fix issue where keyword insertion tag in ad text
        # contains numeric key before uncommenting.
